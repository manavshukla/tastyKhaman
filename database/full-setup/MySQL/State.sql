INSERT INTO `state_master` (`id`, `name`, `countryId`,`code`,`systemInserted`) VALUES
...
UPDATE `state_master` SET deleted = 0, IsActive = 1, createdby = 0, deletedby = 0, financialYear = 0, updatedBy = 0;