INSERT INTO `country_master` (`id`, `sortName`, `name`, `phoneCode`,`systemInserted`) VALUES
...
UPDATE country_master SET deleted = 0, IsActive = 1, createdby = 0, deletedby = 0, financialYear = 0, updatedBy = 0;