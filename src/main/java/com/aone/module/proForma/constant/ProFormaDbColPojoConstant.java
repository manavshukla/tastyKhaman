package com.aone.module.proForma.constant;

public class ProFormaDbColPojoConstant {
	
	public static final String PER_FORMA_NO="per_forma_no";
	...
	private ProFormaDbColPojoConstant() {
